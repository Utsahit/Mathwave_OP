...
-- CreateIndex
CREATE UNIQUE INDEX "DbRole_name_key" ON "DbRole"("name");

-- CreateIndex
CREATE UNIQUE INDEX "DbPermission_name_key" ON "DbPermission"("name");
...
-- CreateIndex
CREATE INDEX "Ingredient_isDeleted_idx" ON "Ingredient"("isDeleted");
...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_roleId_fkey" FOREIGN KEY ("roleId") REFERENCES "DbRole"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RolePermission" ADD CONSTRAINT "RolePermission_roleId_fkey" FOREIGN KEY ("roleId") REFERENCES "DbRole"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RolePermission" ADD CONSTRAINT "RolePermission_permissionId_fkey" FOREIGN KEY ("permissionId") REFERENCES "DbPermission"("id") ON DELETE CASCADE ON UPDATE CASCADE;
